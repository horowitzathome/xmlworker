/*
 * $Id: FontFamilyTest.java 341 2012-06-18 14:38:54Z blowagie $
 *
...
public class FontFamilyTest {
	...
	@Test
	public void resolveSingleQuotedFontFamily() throws IOException {
		Tag t = new Tag(null);
    ...
    @Test
	public void resolveDoubleQuotedFontFamily() throws IOException {
		Tag t = new Tag(null);
		t.getCSS().put("color", "#000000");
		t.getCSS().put("font-family", "\"Helvetica\"");
		t.getCSS().put("font-size", "12pt");
