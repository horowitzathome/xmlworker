/*
 * $Id: HtmlPipelineContextTest.java 437 2013-12-23 12:27:00Z blowagie $
 *
 ...
 *
 */
public class HtmlPipelineContextTest {
	...
	public void verifydefaultPageSize() {
		Assert.assertEquals(PageSize.A4, ctx.getPageSize());
	}
	/**
	...
	public void verifydefaultBookmarksEnabled() {
		Assert.assertEquals(true, ctx.autoBookmark());
	}
	/**
	...
	public void verifydefaultRoottags() {
		Assert.assertEquals(true, ctx.getRootTags().contains("div") && ctx.getRootTags().contains("body"));
	}
	/**
