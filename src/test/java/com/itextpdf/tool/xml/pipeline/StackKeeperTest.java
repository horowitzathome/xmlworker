/*
 * $Id: StackKeeperTest.java 341 2012-06-18 14:38:54Z blowagie $
 *
...
public class StackKeeperTest {
	...
	public void validateFirstAddedElementIsFirst() {
		Assert.assertEquals(a, sk.getElements().get(0));
	}

	@Test
	public void validateMiddleIsMiddle() {
		Assert.assertEquals(b, sk.getElements().get(1));
	}

	@Test
	public void validateLastIsLast() {
		Assert.assertEquals(c, sk.getElements().get(2));
	}
	@Test
	public void validateCount() {
		Assert.assertEquals(3, sk.getElements().size());
	}
	@Test
